import { DFVectorNode, DFListNode, DFLocationNode, DFNumberNode, DFObjectNode, DFStringNode, DFTextNode, VarRefNode, MacroCallNode } from "./parser"

export class DFObject { constructor(n) { this.data = n } } // {a: 2, b: 3}
export class DFList { constructor(n) { this.data = n } } // [2, 3]
export class DFString { constructor(n) { this.data = n } } // "string"
export class DFText { constructor(n) { this.data = n } } // T"<#FFFFFF>text"
export class DFNumber { constructor(n) { this.data = n } } // 1.0, 0xFF, etc
export class DFLocation { constructor(x, y, z, P, Y) { this.x=x;this.y=y;this.z=z;this.pitch=P;this.yaw=Y; } } // (255, 255, 255, 0, 0)
export class DFVector { constructor(x, y, z) { this.x=x;this.y=y;this.z=z; } } // <1, 0, 0>

const locStack = []

export function parseAST(node, macros, vars) {
