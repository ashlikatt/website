import { DFList, DFLocation, DFNumber, DFObject, DFString, DFText, DFVector } from "./ast";
...
const compress = s => btoa(String.fromCharCode.apply(null, [...new Uint16Array(gzip(s))]))
 ...
 */
export function compileObject(object, size) {
