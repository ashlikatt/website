...
import { TokenType, ReverseTokenMap } from "./tokenizer";
...
export class DFObjectNode { constructor(n, m, loc) { this.keys = n; this.vals = m; this.loc = loc; } } // {a: 2, b: 3}
export class DFListNode { constructor(n, loc) { this.data = n; this.loc = loc; } } // [2, 3]
export class DFStringNode { constructor(n, loc) { this.data = n; this.loc = loc; } } // "string"
export class DFTextNode { constructor(n, loc) { this.data = n; this.loc = loc; } } // T"<#FFFFFF>text"
export class DFNumberNode { constructor(n, loc) { this.data = n; this.loc = loc; } } // 1.0, 0xFF, etc
export class DFLocationNode { constructor(x, y, z, P, Y, loc) { this.x=x;this.y=y;this.z=z;this.pitch=P;this.yaw=Y; this.loc = loc; } } // (255, 255, 255, 0, 0)
export class DFVectorNode { constructor(x, y, z, loc) { this.x=x;this.y=y;this.z=z; this.loc = loc; } } // <1, 0, 0>
export class MacroDefNode { constructor(name, args, value, loc) { this.name=name; this.args=args; this.value=value; this.loc = loc; } }
export class MacroCallNode { constructor(name, args, loc) { this.name=name; this.args=args; this.loc = loc; } }
export class VarRefNode { constructor(name, loc) { this.name=name; this.loc = loc; } }
